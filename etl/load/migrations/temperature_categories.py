# %% tags=["parameters"]
upstream = ['create_temperature_categories']
...
csv_file_path = transform_path + "/migrations/temperature_categories.csv"

# Open a database session
session = SessionLocal()

insert_data_from_csv(TemperatureCategory, csv_file_path, session)
